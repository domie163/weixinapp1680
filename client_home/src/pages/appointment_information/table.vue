		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','laboratory_number')" class="col">
						<view class="view">
                            ...
                            <span>实验室编号</span>
								...
								<text>
									{{ o["laboratory_number"] }}
													...
													<view v-if="1 && $check_field('get','laboratory_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>实验室名称</span>
                          </view>
								...
								<text>
									{{ o["laboratory_name"] }}
													...
													<view v-if="0 && $check_field('get','laboratory_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>实验室状态</span>
                          </view>
                            ...
                            <span>预约时间</span>
								...
								<text>
									{{ $toTime(o["time_of_appointment"],"yyyy-MM-dd hh:mm:ss") }}
													...
													<view v-if="0 && $check_field('get','appointment_duration')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>预约时长</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["appointment_duration"] }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','appointment_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>预约状态</span>
                          </view>
		...
		data() {
			return {
                ...
                list_user_appointment_users: [],
                                        // 预约状态列表
                list_appointment_status: [{value:"",text:"全部"}],
                			}
		},
		methods: {
          search() {
