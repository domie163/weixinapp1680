		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','consumable_number')" class="col">
						<view class="view">
                            ...
                            <span>耗材编号</span>
								...
								<text>
									{{ o["consumable_number"] }}
													...
													<view v-if="1 && $check_field('get','consumable_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>耗材名称</span>
                          </view>
								...
								<text>
									{{ o["consumable_name"] }}
													...
													<view v-if="1 && $check_field('get','item_specifications')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>物品规格</span>
                          </view>
								...
								<text>
									{{ o["item_specifications"] }}
													...
													<view v-if="0 && $check_field('get','consumable_price')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>耗材价格</span>
                          </view>
                            ...
                            <span>购买用户</span>
								...
								<text>
									{{ get_user_purchasing_users(o['purchasing_users']) }}
													...
													<view v-if="0 && $check_field('get','purchase_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>购买时间</span>
                          </view>
                            ...
                            <span>购买数量</span>
								...
								<text>
									{{ o['purchase_quantity'] }}
													...
													<view v-if="0 && $check_field('get','purchase_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>购买状态</span>
                          </view>
		...
		data() {
			return {
                ...
                list_user_purchasing_users: [],
                                        // 购买状态列表
                list_purchase_status: [{value:"",text:"全部"}],
                                        model:false,
                paywayact:0,
                // 支付方式
                payway:[
